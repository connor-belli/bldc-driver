...
const uint16_t sine_table[] = { 0x8000,0x80c9,0x8192,0x825b,0x8324,0x83ee,0x84b7,0x8580,
...
// Input range [0, 65536]
// Output range [-32768, 32768]
// One period sine wave
int16_t fp_sin(uint16_t t) {
	uint16_t ind = t >> 6;
	int16_t val = sine_table[ind];
	return val;
}
